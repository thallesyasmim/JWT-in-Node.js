...
const sign = payload => jwt.sign(payload, config.jwt.privateKey, signOptions) // jwt.decode() - return information of payload | jwt.sign() - generate new jwt | jwt.verify() - verify signature and return information payload
// yasmim - secret
